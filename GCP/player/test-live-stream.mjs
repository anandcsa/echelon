...
try{
 ...
 if(touch){
  await page.locator('#interact').click();await page.waitForTimeout(1000);
 ...
 console.log(JSON.stringify({url,touch,relay:process.env.ECHELON_RELAY==='1',audio,status:await page.locator('#status').innerText(),before,after,errors,screenshot:shot},null,2));
